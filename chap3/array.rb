...
zeros = Array.new(4, 0) # [0, 0, 0, 0]: new array with 4 zeros
copy = Array.new(nils) # [nil, nil, nil]: new array with 3 nil elements
count = Array.new(3) { |i| i + 1 } # [1, 2, 3]: new array with 3 elements
